...
public class InstanceRuleCosts extends RoadwayRulesCosts{
	...
	private SimulationRoadwayResponse calcTotalCostsRoadway(Roadway roadwayBRE_Obj, SimulationRoadwayDto requestData) {
		...
		simulationRoadwayResponse_Dto = new SimulationRoadwayResponse(requestData.googleTracking.distance_total,requestData.googleTracking.duration,tollsTotal_CountryAll,requestData, costsVehicle_L, new Date());
