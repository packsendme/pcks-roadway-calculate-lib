...
public class Motorcycle extends Roadway_Abstract{

	public Motorcycle(GoogleAPITrackingResponse_Dto simulationTrackingAPI, SimulationDataForCalculateRequest_Dto simulationData) {
		super(simulationTrackingAPI, simulationData, Roadway_Constants.ROADWAY_MOTORCYCLE);
	}
