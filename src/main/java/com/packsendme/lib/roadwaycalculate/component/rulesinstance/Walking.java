...
public class Walking extends Roadway_Abstract{
	...
	public Walking(GoogleAPITrackingResponse_Dto simulationTrackingAPI, SimulationDataForCalculateRequest_Dto simulationData) {
		super(simulationTrackingAPI, simulationData, Roadway_Constants.ROADWAY_WALKING);
	}
